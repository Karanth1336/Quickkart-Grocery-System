...
PRODUCTS = [
    # Dairy & Eggs
    (1,  "Milk 1L",           "Dairy & Eggs",        32,  "https://images.unsplash.com/photo-1550583724-b2692b85b150?w=300&h=300&fit=crop&auto=format"),
    (2,  "Butter 500g",       "Dairy & Eggs",        55,  "https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=300&h=300&fit=crop&auto=format"),
    (3,  "Paneer 200g",       "Dairy & Eggs",        80,  "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=300&h=300&fit=crop&auto=format"),
    (4,  "Curd 400g",         "Dairy & Eggs",        45,  "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=300&h=300&fit=crop&auto=format"),
    (5,  "Eggs (6 pack)",     "Dairy & Eggs",        65,  "https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?w=300&h=300&fit=crop&auto=format"),
    (6,  "Cheese Slice 200g", "Dairy & Eggs",        95,  "https://images.unsplash.com/photo-1618164436241-4473940d1f5c?w=300&h=300&fit=crop&auto=format"),
    (7,  "Ghee 500ml",        "Dairy & Eggs",       280,  "https://images.unsplash.com/photo-1596649299486-4cdea56fd59d?w=300&h=300&fit=crop&auto=format"),
    (8,  "Skimmed Milk 1L",   "Dairy & Eggs",        38,  "https://images.unsplash.com/photo-1563636619-e9143da7973b?w=300&h=300&fit=crop&auto=format"),
    # Fruits & Vegetables
    (9,  "Apple (1 kg)",      "Fruits & Vegetables", 120, "https://images.unsplash.com/photo-1567306226416-28f0efdc88ce?w=300&h=300&fit=crop&auto=format"),
    (10, "Banana (6 pcs)",    "Fruits & Vegetables",  45, "https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=300&h=300&fit=crop&auto=format"),
    (11, "Tomato (500g)",     "Fruits & Vegetables",  30, "https://images.unsplash.com/photo-1546094096-0df4bcaaa337?w=300&h=300&fit=crop&auto=format"),
    (12, "Onion (1 kg)",      "Fruits & Vegetables",  35, "https://images.unsplash.com/photo-1518977956812-cd3dbadaaf31?w=300&h=300&fit=crop&auto=format"),
    (13, "Potato (1 kg)",     "Fruits & Vegetables",  28, "https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=300&h=300&fit=crop&auto=format"),
    (14, "Spinach (250g)",    "Fruits & Vegetables",  22, "https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=300&h=300&fit=crop&auto=format"),
    (15, "Carrot (500g)",     "Fruits & Vegetables",  35, "https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=300&h=300&fit=crop&auto=format"),
    (16, "Capsicum (500g)",   "Fruits & Vegetables",  55, "https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=300&h=300&fit=crop&auto=format"),
    (17, "Mango (1 kg)",      "Fruits & Vegetables", 130, "https://images.unsplash.com/photo-1553279768-865429fa0078?w=300&h=300&fit=crop&auto=format"),
    (18, "Grapes (500g)",     "Fruits & Vegetables",  85, "https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=300&h=300&fit=crop&auto=format"),
    # Staples & Grains
    (19, "Basmati Rice 5kg",  "Staples & Grains",    380, "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=300&h=300&fit=crop&auto=format"),
    (20, "Wheat Flour 5kg",   "Staples & Grains",    220, "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=300&h=300&fit=crop&auto=format"),
    (21, "Toor Dal 1kg",      "Staples & Grains",    145, "https://images.unsplash.com/photo-1585996610809-8b6de5b16fe3?w=300&h=300&fit=crop&auto=format"),
    (22, "Moong Dal 1kg",     "Staples & Grains",    130, "https://images.unsplash.com/photo-1515543904379-3d757afe72e4?w=300&h=300&fit=crop&auto=format"),
    (23, "Chana Dal 1kg",     "Staples & Grains",    120, "https://images.unsplash.com/photo-1611171711791-b34e9e83b845?w=300&h=300&fit=crop&auto=format"),
    (24, "Poha 500g",         "Staples & Grains",     48, "https://images.unsplash.com/photo-1559561853-08451507cbe7?w=300&h=300&fit=crop&auto=format"),
    (25, "Semolina 1kg",      "Staples & Grains",     55, "https://images.unsplash.com/photo-1612257416648-504d65735fef?w=300&h=300&fit=crop&auto=format"),
    (26, "Oats 500g",         "Staples & Grains",     90, "https://images.unsplash.com/photo-1614961233913-a5113a4a34ed?w=300&h=300&fit=crop&auto=format"),
    # Oils & Condiments
    (27, "Sunflower Oil 1L",  "Oils & Condiments",   145, "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=300&h=300&fit=crop&auto=format"),
    (28, "Mustard Oil 1L",    "Oils & Condiments",   135, "https://images.unsplash.com/photo-1543364195-bfe6e4932397?w=300&h=300&fit=crop&auto=format"),
    (29, "Olive Oil 500ml",   "Oils & Condiments",   420, "https://images.unsplash.com/photo-1601039641847-7857b994d704?w=300&h=300&fit=crop&auto=format"),
    (30, "Salt 1kg",          "Oils & Condiments",    22, "https://images.unsplash.com/photo-1518110925495-5fe2fda0442c?w=300&h=300&fit=crop&auto=format"),
    (31, "Sugar 1kg",         "Oils & Condiments",    45, "https://images.unsplash.com/photo-1581441363689-1f3c3c413112?w=300&h=300&fit=crop&auto=format"),
    (32, "Ketchup 500g",      "Oils & Condiments",    85, "https://images.unsplash.com/photo-1607189469666-b58b1da3e84b?w=300&h=300&fit=crop&auto=format"),
    (33, "Soy Sauce 200ml",   "Oils & Condiments",    65, "https://images.unsplash.com/photo-1582591945291-7b94c5c7d7c6?w=300&h=300&fit=crop&auto=format"),
    (34, "Vinegar 500ml",     "Oils & Condiments",    55, "https://images.unsplash.com/photo-1565060169194-19fabf63012c?w=300&h=300&fit=crop&auto=format"),
    # Snacks & Munchies
    (35, "Lay's Classic 100g","Snacks & Munchies",    20, "https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=300&h=300&fit=crop&auto=format"),
    (36, "Kurkure 90g",       "Snacks & Munchies",    20, "https://images.unsplash.com/photo-1621447504864-d8686e12698c?w=300&h=300&fit=crop&auto=format"),
    (37, "Biscuits Marie",    "Snacks & Munchies",    30, "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=300&h=300&fit=crop&auto=format"),
    (38, "Parle-G 800g",      "Snacks & Munchies",    55, "https://images.unsplash.com/photo-1597733336794-12d05021d510?w=300&h=300&fit=crop&auto=format"),
    (39, "Maggi 2-min 12pk",  "Snacks & Munchies",   140, "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?w=300&h=300&fit=crop&auto=format"),
    (40, "Popcorn Salted",    "Snacks & Munchies",    45, "https://images.unsplash.com/photo-1505686994434-e3cc5abf1330?w=300&h=300&fit=crop&auto=format"),
    (41, "Peanuts 200g",      "Snacks & Munchies",    35, "https://images.unsplash.com/photo-1567892737950-30c4db37cd89?w=300&h=300&fit=crop&auto=format"),
    (42, "Cashews 200g",      "Snacks & Munchies",   180, "https://images.unsplash.com/photo-1607113256158-56a934936ef6?w=300&h=300&fit=crop&auto=format"),
    (43, "Almonds 200g",      "Snacks & Munchies",   220, "https://images.unsplash.com/photo-1574184864703-3487b13f0edd?w=300&h=300&fit=crop&auto=format"),
    # Beverages
    (44, "Coca-Cola 2L",      "Beverages",            90, "https://images.unsplash.com/photo-1561758033-d89a9ad46330?w=300&h=300&fit=crop&auto=format"),
    (45, "Pepsi 2L",          "Beverages",            88, "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=300&h=300&fit=crop&auto=format"),
    (46, "Tropicana OJ 1L",   "Beverages",           125, "https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=300&h=300&fit=crop&auto=format"),
    (47, "Green Tea 25 bags",  "Beverages",           110, "https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=300&h=300&fit=crop&auto=format"),
    (48, "Coffee Nescafe 100g","Beverages",           235, "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=300&h=300&fit=crop&auto=format"),
    (49, "Water 5L",           "Beverages",            50, "https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=300&h=300&fit=crop&auto=format"),
    (50, "Red Bull 250ml",     "Beverages",           125, "https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=300&h=300&fit=crop&auto=format"),
    (51, "Lassi 500ml",        "Beverages",            55, "https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=300&h=300&fit=crop&auto=format"),
    # Bakery & Bread
    (52, "White Bread",        "Bakery & Bread",       40, "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=300&h=300&fit=crop&auto=format"),
    (53, "Brown Bread",        "Bakery & Bread",       48, "https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=300&h=300&fit=crop&auto=format"),
    (54, "Multigrain Bread",   "Bakery & Bread",       55, "https://images.unsplash.com/photo-1549931319-a545dcf3bc7c?w=300&h=300&fit=crop&auto=format"),
    (55, "Pav (8 pcs)",        "Bakery & Bread",       30, "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=300&h=300&fit=crop&auto=format"),
    (56, "Croissant 2pc",      "Bakery & Bread",       65, "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=300&h=300&fit=crop&auto=format"),
    (57, "Muffin Choco",       "Bakery & Bread",       55, "https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=300&h=300&fit=crop&auto=format"),
    # Chocolates & Sweets
    (58, "Dairy Milk 50g",     "Chocolates & Sweets",  60, "https://images.unsplash.com/photo-1548907040-4baa42d10919?w=300&h=300&fit=crop&auto=format"),
    (59, "KitKat 4 finger",    "Chocolates & Sweets",  30, "https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=300&h=300&fit=crop&auto=format"),
    (60, "5 Star Bar",         "Chocolates & Sweets",  20, "https://images.unsplash.com/photo-1621939514649-280e2ee25f60?w=300&h=300&fit=crop&auto=format"),
    (61, "Munch Bar",          "Chocolates & Sweets",  10, "https://images.unsplash.com/photo-1575377427642-087cf684f29d?w=300&h=300&fit=crop&auto=format"),
    (62, "Ferrero Rocher 4pc", "Chocolates & Sweets", 200, "https://images.unsplash.com/photo-1599599810769-bcde5a160d32?w=300&h=300&fit=crop&auto=format"),
    (63, "Oreo Original",      "Chocolates & Sweets",  40, "https://images.unsplash.com/photo-1588345921523-c2dcdb7f1dcd?w=300&h=300&fit=crop&auto=format"),
    (64, "Gulab Jamun 500g",   "Chocolates & Sweets",  95, "https://images.unsplash.com/photo-1626776877408-3e4ec3b3e2a7?w=300&h=300&fit=crop&auto=format"),
    # Spices & Masalas
    (65, "Turmeric 100g",      "Spices & Masalas",     28, "https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=300&h=300&fit=crop&auto=format"),
    (66, "Red Chilli 100g",    "Spices & Masalas",     30, "https://images.unsplash.com/photo-1585571788004-5dfef8f9f8f3?w=300&h=300&fit=crop&auto=format"),
    (67, "Cumin Seeds 100g",   "Spices & Masalas",     32, "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=300&h=300&fit=crop&auto=format"),
    (68, "Coriander Pwd 100g", "Spices & Masalas",     28, "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop&auto=format"),
    (69, "Garam Masala 100g",  "Spices & Masalas",     55, "https://images.unsplash.com/photo-1590301157890-4810ed352733?w=300&h=300&fit=crop&auto=format"),
    (70, "Chai Masala 50g",    "Spices & Masalas",     45, "https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=300&h=300&fit=crop&auto=format"),
    (71, "Black Pepper 50g",   "Spices & Masalas",     65, "https://images.unsplash.com/photo-1506368083636-6defb67639a7?w=300&h=300&fit=crop&auto=format"),
    (72, "Cardamom 20g",       "Spices & Masalas",     80, "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=300&h=300&fit=crop&auto=format"),
    # Frozen Foods
    (73, "Frozen Peas 500g",   "Frozen Foods",         65, "https://images.unsplash.com/photo-1587735243615-c03f25aaff15?w=300&h=300&fit=crop&auto=format"),
    (74, "Frozen Corn 500g",   "Frozen Foods",         68, "https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=300&h=300&fit=crop&auto=format"),
    (75, "Aloo Tikki 8pc",     "Frozen Foods",        120, "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=300&h=300&fit=crop&auto=format"),
    (76, "Chicken Nuggets",    "Frozen Foods",        185, "https://images.unsplash.com/photo-1562802378-063ec186a863?w=300&h=300&fit=crop&auto=format"),
    (77, "Frozen Paratha 5pc", "Frozen Foods",         95, "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=300&h=300&fit=crop&auto=format"),
    (78, "Ice Cream Vanilla 500ml","Frozen Foods",    130, "https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?w=300&h=300&fit=crop&auto=format"),
    (79, "Ice Cream Choco 500ml", "Frozen Foods",     135, "https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=300&h=300&fit=crop&auto=format"),
    # Personal Care
    (80, "Dove Soap 100g",     "Personal Care",        48, "https://images.unsplash.com/photo-1604335399105-a0c585fd81a1?w=300&h=300&fit=crop&auto=format"),
    (81, "Dettol Soap 125g",   "Personal Care",        45, "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=300&h=300&fit=crop&auto=format"),
    (82, "Colgate 200g",       "Personal Care",        65, "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=300&h=300&fit=crop&auto=format"),
    (83, "Shampoo Head S 180ml","Personal Care",       195, "https://images.unsplash.com/photo-1585751119414-ef2636f8aede?w=300&h=300&fit=crop&auto=format"),
    (84, "Dettol Handwash 200ml","Personal Care",       85, "https://images.unsplash.com/photo-1584515933487-779824d29309?w=300&h=300&fit=crop&auto=format"),
    (85, "Face Wash 100ml",    "Personal Care",        145, "https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=300&h=300&fit=crop&auto=format"),
    # Household
    (86, "Vim Dish Soap 500ml","Household",             85, "https://images.unsplash.com/photo-1563453392212-326f5e854473?w=300&h=300&fit=crop&auto=format"),
    (87, "Harpic 500ml",       "Household",             95, "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=300&h=300&fit=crop&auto=format"),
    (88, "Colin Glass 500ml",  "Household",            110, "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop&auto=format"),
    (89, "Surf Excel 1kg",     "Household",            185, "https://images.unsplash.com/photo-1545173168-9f1947eebb7f?w=300&h=300&fit=crop&auto=format"),
    (90, "Odonil Blocks 2pc",  "Household",             65, "https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?w=300&h=300&fit=crop&auto=format"),
    (91, "Tissue Roll 4pk",    "Household",            120, "https://images.unsplash.com/photo-1584556812952-905ffd0c611a?w=300&h=300&fit=crop&auto=format"),
    (92, "Garbage Bags 30pc",  "Household",             65, "https://images.unsplash.com/photo-1594041680534-e8c8cdebd659?w=300&h=300&fit=crop&auto=format"),
    # Baby & Kids
    (93, "Pampers S 56pc",     "Baby & Kids",          650, "https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=300&h=300&fit=crop&auto=format"),
    (94, "Baby Wipes 80pc",    "Baby & Kids",          180, "https://images.unsplash.com/photo-1522771930-78848d9293e8?w=300&h=300&fit=crop&auto=format"),
    (95, "Cerelac 300g",       "Baby & Kids",          245, "https://images.unsplash.com/photo-1555812636-b827bea2e97f?w=300&h=300&fit=crop&auto=format"),
    (96, "Kids Biscuit 200g",  "Baby & Kids",           55, "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=300&h=300&fit=crop&auto=format"),
    (97, "Johnson Baby Oil",   "Baby & Kids",          165, "https://images.unsplash.com/photo-1519689680058-324335c77eba?w=300&h=300&fit=crop&auto=format"),
    # Pet Supplies
    (98,  "Dog Food 1kg",      "Pet Supplies",         320, "https://images.unsplash.com/photo-1601758124510-52d02ddb7cbd?w=300&h=300&fit=crop&auto=format"),
    (99,  "Cat Food 400g",     "Pet Supplies",         180, "https://images.unsplash.com/photo-1589883661923-6476cb0ae9f2?w=300&h=300&fit=crop&auto=format"),
    (100, "Pet Shampoo 200ml", "Pet Supplies",         145, "https://images.unsplash.com/photo-1583511655826-05700442976a?w=300&h=300&fit=crop&auto=format"),
]
...
def init_db():
    ...
    # Update images for existing rows (migrates old local paths to Unsplash URLs)
    cur.executemany("UPDATE products SET image=? WHERE id=?", [(p[4], p[0]) for p in PRODUCTS])
